...
public class AltDudeNotFull extends Entity implements Animation, Actionable, Movable{
    ...
    public AltDudeNotFull(String id, Point position, List<PImage> images, int resourceLimit, int resourceCount, double actionPeriod, double animationPeriod, int health, int healthLimit) {
