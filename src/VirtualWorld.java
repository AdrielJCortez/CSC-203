...
public final class VirtualWorld extends PApplet {
    private static String[] ARGS; // i picked the best doctor and clown pictures
    ...
    */
    ...
    public void mousePressed() {
        ...
        if (entityOptional.isPresent()) {
            ...
            System.out.println(entity.getId() + ": " + entity.getClass().getSimpleName() + " : " + entity.getHealth());
        }
    }
    ...
    public void scheduleActions(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
        for (Entity entity : world.getEntities()) {
            if (entity instanceof Actionable actionableEntity) {
                actionableEntity.scheduleActions(scheduler, world, imageStore);
            }
        }
    }
    ...
    public void keyPressed() {
        ...
        if (key == 'C' || key == 'c') {
            CircusArea.spawnCircus(world, scheduler, imageStore);
        }
        if (key == 'H' || key == 'h') {
            HospitalArea.spawnHospital(world, scheduler, imageStore);
        }
        if (key == 'R' || key == 'r') {
            CircusArea.deleteCircus(world, scheduler);
        }
